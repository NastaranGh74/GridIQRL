...
torch.save(q_network.state_dict(), 'DQN_136_1000.pt')
...
All_Returns.to_csv('DQN_136_1000.csv')
MSE_loss.to_csv('DQN_MSE_loss_136_1000.csv')

system_loss = pd.DataFrame(system_loss)
voltage_penalty = pd.DataFrame(voltage_penalty)
system_loss.to_csv('system_lossDQN_136_1000.csv')
voltage_penalty.to_csv('voltage_penaltyDQN_136_1000.csv')
